...
{\ctikzvalof{bipoles/generic/width}}
{
	...
	\pgfscope
		...
		\pgfpathmoveto{\pgfpoint{.8\pgf@circ@res@left}{0cm}}
		\pgfpathsine{\pgfpoint{.4\pgf@circ@res@right}{.5\pgf@circ@res@up}}
		\pgfpathcosine{\pgfpoint{.4\pgf@circ@res@right}{-.5\pgf@circ@res@up}}
		\pgfpathsine{\pgfpoint{.4\pgf@circ@res@right}{-.5\pgf@circ@res@up}}
		\pgfpathcosine{\pgfpoint{.4\pgf@circ@res@right}{.5\pgf@circ@res@up}}
		\pgfusepath{draw}
	\endpgfscope
...
\pgfcirc@activate@bipole@simple{l}{singeneric}
...
% % % basic oosources
\ctikzset{bipoles/oosource/height/.initial=.39} % 0.65*0.6 to maintain the original size
\ctikzset{bipoles/oosource/width/.initial=.60}
% this is only needed to fix a horrible code in one example of the manual before v1.8.3
\ctikzset{bipoles/oosource/circlesize/.code={%
        \pgfmathsetmacro{\@@hack@oo@h}{0.6*#1}\ctikzset{bipoles/oosource/height=\@@hack@oo@h}
        \pgfutil@packagewarning{circuitikz}{Do not use circlesize with oo-style source! Use width and height}
}}
\ctikzset{bipoles/oosource/circleoffset/.code={%
        \pgfmathsetmacro{\@@hack@oo@w}{0.6*#1+0.3}\ctikzset{bipoles/oosource/width=\@@hack@oo@w}
        \pgfutil@packagewarning{circuitikz}{Do not use circleoffset with oo-style source! Use width and height}
}}

% % % oo autotransformer
\ctikzset{bipoles/oosourceatrans/height/.initial=.36}
\ctikzset{bipoles/oosourceatrans/width/.initial=.5}
% the number here is, for compatibility, (0.6/0.36)**2*1.2
\ctikzset{bipoles/oosourceatrans/vectorgroupscale/.initial=3.33}% better if it's a bit bigger

% % % ootransformer
\ctikzset{bipoles/oosourcetrans/height/.initial=.36}
\ctikzset{bipoles/oosourcetrans/width/.initial=.6}
% the number here is, for compatibility, (0.6/0.36)**2
\ctikzset{bipoles/oosourcetrans/vectorgroupscale/.initial=2.78}
\ctikzset{bipoles/oosourcetrans/vectorgroupoffset/.initial=0.6}

% % % oootransformer
\ctikzset{bipoles/ooosource/height/.initial=.6}
\ctikzset{bipoles/ooosource/width/.initial=.5640} % the h and w are TIGHTLY related!
\ctikzset{bipoles/ooosource/vectorgroupscale/.initial=1}
\ctikzset{bipoles/oosourcetrans/vectorgroupoffset/.initial=0.6}

%%% key to change size globally
\ctikzset{ootrans size/.is choice}
\ctikzset{ootrans size/small/.code={%
    \ctikzset{bipoles/oosourceatrans/height/.initial=.36}%
    \ctikzset{bipoles/oosourceatrans/width/.initial=.5}%
    \ctikzset{bipoles/oosourcetrans/height/.initial=.36}%
    \ctikzset{bipoles/oosourcetrans/width/.initial=.6}%
    \ctikzset{bipoles/ooosource/height/.initial=.6}%
    \ctikzset{bipoles/ooosource/width/.initial=.5640}%
    }
}
\ctikzset{ootrans size/large/.code={%
    \ctikzset{bipoles/oosourceatrans/height/.initial=.6}%
    \ctikzset{bipoles/oosourceatrans/width/.initial=.83333}%
    \ctikzset{bipoles/oosourcetrans/height/.initial=.6}%
    \ctikzset{bipoles/oosourcetrans/width/.initial=.83333}%
    \ctikzset{bipoles/ooosource/height/.initial=1.0909}%
    \ctikzset{bipoles/ooosource/width/.initial=1.0255}%
    }
}
...
% % % additional winding for oosource[a]trans
\newif\ifpgf@circ@ooupperwinding
\pgfkeys{tikz/oo upper winding/.code={\pgf@circ@ooupperwindingtrue%
    \ctikzset{bipoles/oosourcetrans/upper circle size=#1}%
}}
\pgfkeys{tikz/oo upper winding/.default=\ctikzvalof{bipoles/oosourcetrans/upper circle size default}}
\ctikzset{bipoles/oosourcetrans/upper circle size/.initial=.7}
\ctikzset{bipoles/oosourcetrans/upper circle size default/.initial=.7}
% the default for the upper position is chosen so that it seems more or less
% the same as a rotated ooosource
\ctikzset{bipoles/oosourcetrans/upper circle offset/.initial=1.3}
\newif\ifpgf@circ@upper@delta
\newif\ifpgf@circ@upper@wye
\newif\ifpgf@circ@upper@eyw
\newif\ifpgf@circ@upper@zig
\pgfkeys{tikz/upper/.is choice}
\pgfkeys{tikz/upper/delta/.add code={}{\pgf@circ@upper@deltatrue}}
\pgfkeys{tikz/upper/wye/.add code={}{\pgf@circ@upper@wyetrue}}
\pgfkeys{tikz/upper/eyw/.add code={}{\pgf@circ@upper@eywtrue}}
\pgfkeys{tikz/upper/zig/.add code={}{\pgf@circ@upper@zigtrue}}%
...
{\ctikzvalof{bipoles/oosource/width}}
{
    ...
    % the height is the circle size; the width will decide how far away the two circles are drawn
    \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@left+\pgf@circ@res@up}{0}}{\pgf@circ@res@up}
    \pgf@circ@maybefill
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@up}{0}}{\pgf@circ@res@up}
    \pgf@circ@draworfill
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@left+\pgf@circ@res@up}{0}}{\pgf@circ@res@up}
    \pgfusepath{draw}
...
\ctikzset{sources/symbol/delta rot/.initial={0}}
\ctikzset{sources/symbol/wye rot/.initial={0}}
\ctikzset{sources/symbol/eyw rot/.initial={0}}
\ctikzset{sources/symbol/zig rot/.initial={0}}
\ctikzset{sources/symbol/prim rot/.initial={0}}
\ctikzset{sources/symbol/sec rot/.initial={0}}
\ctikzset{sources/symbol/tert rot/.initial={0}}
\ctikzset{sources/symbol/upper rot/.initial={0}}
% Notice that the scale of the symbol should go with the size of the circle, which in the oo-type
% components is linked to the .../height key, which translates in ...res@up and ...res@down
% triangle
\def\pgf@circ@delta#1{
    \pgfscope
        \pgftransformscale{-.015*\ctikzvalof{\ctikzclass/symbol/delta scale}*\pgf@circ@res@up*#1}
        \pgftransformrotate{\ctikzvalof{\ctikzclass/symbol/delta rot}}
...
\def\pgf@circ@wye#1{
    \pgfscope
        \pgftransformscale{-.015*\ctikzvalof{\ctikzclass/symbol/wye scale}*\pgf@circ@res@up*#1}
        \pgftransformrotate{\ctikzvalof{\ctikzclass/symbol/wye rot}}
        \def\pgfcircmathresult{\expandafter\pgf@circ@stripdecimals\pgf@circ@direction\pgf@nil}
            \pgftransformrotate{-\pgfcircmathresult}
        \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
        \pgf@circ@set@relative@thickness{symbol/thickness}
...
\def\pgf@circ@eyw#1{
    \pgfscope
        \pgftransformscale{-.015*\ctikzvalof{\ctikzclass/symbol/eyw scale}*\pgf@circ@res@up*#1}
        \pgftransformrotate{\ctikzvalof{\ctikzclass/symbol/eyw rot}}
        \def\pgfcircmathresult{\expandafter\pgf@circ@stripdecimals\pgf@circ@direction\pgf@nil}
        \pgftransformrotate{-\pgfcircmathresult}
        \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
        \pgf@circ@set@relative@thickness{symbol/thickness}
...
\def\pgf@circ@zig#1{
    \pgfscope
        \pgftransformscale{-.015*\ctikzvalof{\ctikzclass/symbol/zig scale}*\pgf@circ@res@up*#1}
        \pgftransformrotate{\ctikzvalof{\ctikzclass/symbol/zig rot}}
        \def\pgfcircmathresult{\expandafter\pgf@circ@stripdecimals\pgf@circ@direction\pgf@nil}
        \pgftransformrotate{-\pgfcircmathresult}
...
\pgfcircdeclarebipolescaled{sources}
{
    \savedmacro{\vectorgroupoffset}{\edef\vectorgroupoffset{%
        \ctikzvalof{bipoles/oosourcetrans/vectorgroupoffset}}}
    \savedmacro{\uppercirclesize}{\edef\uppercirclesize{%
        \ctikzvalof{bipoles/oosourcetrans/upper circle size}}}
    \savedmacro{\uppercircleoffset}{\edef\uppercircleoffset{%
        \ctikzvalof{bipoles/oosourcetrans/upper circle offset}}}
    %
    \anchor{centerprim}{
        \northeast
        \advance\pgf@x by -\pgf@y
    ...
    \anchor{symbolupper}{
        ...
        \pgf@ya=\uppercirclesize\pgf@ya
        \advance\pgf@y by \vectorgroupoffset\pgf@ya
    }
    \anchor{primup}{
        \northeast
        \pgf@ya=0.70711\pgf@y
        \advance\pgf@x by -\pgf@y\advance\pgf@x by \pgf@ya
        \pgf@y=\pgf@ya
    }
    \anchor{primdown}{
        \northeast
    ...
    \anchor{centerupper}{
        \northeast
        \pgf@ya=\pgf@y
        \pgf@y=\uppercircleoffset\pgf@ya
        \advance\pgf@x by -\pgf@ya
    }
    \anchor{uppertop}{
        \northeast
        \pgf@ya=\pgf@y
        \pgf@y=\uppercircleoffset\pgf@ya
        \advance \pgf@y by \uppercirclesize\pgf@ya
        \advance\pgf@x by -\pgf@ya
    }
    \anchor{topright}{
        \northeast
        ...
        \pgf@y=\uppercircleoffset\pgf@ya
        \advance\pgf@x by -\pgf@ya
        \pgf@ya=0.70711\pgf@ya\pgf@ya=\uppercirclesize\pgf@ya
...
{\ctikzvalof{bipoles/oosourceatrans/width}}
{
    ...
    % if we want to fill the extra winding, we need to pre-fill the circle
    \ifpgf@circ@ooupperwinding
        \pgfpathcircle{\pgfpoint{\pgf@circ@res@other}{\uppercircleoffset\pgf@circ@res@up}}
            {\uppercirclesize\pgf@circ@res@up}
        \pgf@circ@maybefill
    \fi
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@other}{0}}{\pgf@circ@res@up}
    \pgf@circ@draworfill
    % draw arc
    \pgfpathmoveto{\pgfpoint{\pgf@circ@res@other}{\pgf@circ@res@up}}
    \pgfpathcurveto{\pgfpoint{0.3\pgf@circ@res@left}{\pgf@circ@res@up}}
        {\pgfpoint{0.5\pgf@circ@res@left}{\pgf@circ@res@up}}
    ...
    \ifpgf@circ@prim@delta
        \pgfscope
            ...
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/oosourceatrans/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@prim@wye
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@wye{\ctikzvalof{bipoles/oosourceatrans/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@prim@eyw
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@eyw{\ctikzvalof{bipoles/oosourceatrans/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@prim@zig
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@zig{\ctikzvalof{bipoles/oosourceatrans/vectorgroupscale}}
        \endpgfscope
    \fi\fi\fi\fi
    %%upper additional winding. Notice that we do *not* scale the symbol. At least not for now...
    \ifpgf@circ@ooupperwinding
    \ifpgf@circ@upper@delta
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformyshift{\pgf@circ@res@up}
            \pgftransformyshift{\vectorgroupoffset*\uppercirclesize*\pgf@circ@res@up}
            \pgftransformrotate{\ctikzvalof{sources/symbol/upper rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/oosourcetrans/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@upper@wye
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformyshift{\pgf@circ@res@up}
            \pgftransformyshift{\vectorgroupoffset*\uppercirclesize*\pgf@circ@res@up}
...
\pgfcircdeclarebipolescaled{sources}
{
    ...
    % border anchors to contact three wires if needed
    \anchor{primup}{
        \northeast
        \pgf@ya=0.70711\pgf@y
        \advance\pgf@x by -\pgf@y\pgf@x=-\pgf@x\advance\pgf@x by -\pgf@ya
        \pgf@y=\pgf@ya
    }
    \anchor{primdown}{
        \northeast
...
{\ctikzvalof{bipoles/oosourcetrans/width}}
{
    ...
    % if we want to fill the extra winding, we need to pre-fill the circle
    \ifpgf@circ@ooupperwinding
        \pgfpathcircle{\pgfpoint{0}{\uppercircleoffset\pgf@circ@res@up}}
            {\uppercirclesize\pgf@circ@res@up}
        \pgf@circ@maybefill
    \fi
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@left+\pgf@circ@res@up}{0}}{\pgf@circ@res@up}
    ...
    \ifpgf@circ@prim@delta
        \pgfscope
            \pgftransformxshift{\vectorgroupoffset\pgf@circ@res@left}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/oosourcetrans/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@prim@wye
    ...
    \ifpgf@circ@sec@delta
        \pgfscope
            \pgftransformxshift{\vectorgroupoffset\pgf@circ@res@right}
            \pgftransformrotate{\ctikzvalof{sources/symbol/sec rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/oosourcetrans/vectorgroupscale}}
        \endpgfscope
...
%%% fit the ooo-shape to the geo-anchors
\def\pgf@circ@ooo@find@other{
    %% we want the structure of height @up. The (half)height of the drawing is:
    %% h=other*[(1-r)*sin(60)+r] --- so we calculate the other we need to fill the vertical space
    \pgfmathsetlength{\pgf@circ@res@other}{%
        \pgf@circ@res@up/(\circleoffset*sqrt(3)/2+\circlesize)
    }
}
\def\pgf@circ@ooo@anchor@base{
    \pgf@circ@scaled@Rlen=\ctikzvalof{\ctikzclass/scale}\pgf@circ@Rlen
    \pgf@circ@res@up=\ctikzvalof{bipoles/ooosource/height}\pgf@circ@scaled@Rlen
    \pgf@circ@res@up=0.5\pgf@circ@res@up
    \pgf@circ@ooo@find@other
    \pgfmathsetlength{\pgf@circ@res@temp}{\circleoffset*\pgf@circ@res@other/4}
}
% % % % ooosource for three phase transformer
%%% we find the circle size from the ratio height/width. Change with care.
\pgfcircdeclarebipolescaled{sources}
{
    %% From the geometry of the component, we know that the width of the drawing is:
    %% w = (1/2*r + 3/2)/((1-r)*sin(60)+r) *(h/2)
    %% we reverse that and we have
    %% r = (3-sqrt(3)*2*w/h)/((2-sqrt(3)*2*w/h-1)
    \savedmacro{\circlesize}{%
        \pgfmathparse{%
            (3-sqrt(3)*2*\ctikzvalof{bipoles/ooosource/width}/\ctikzvalof{bipoles/ooosource/height})/
            ((2-sqrt(3))*2*\ctikzvalof{bipoles/ooosource/width}/\ctikzvalof{bipoles/ooosource/height}-1)
        }
        \edef\circlesize{\pgfmathresult}
    }
    \savedmacro{\circleoffset}{%
        \pgfmathparse{%
            1-(3-sqrt(3)*2*\ctikzvalof{bipoles/ooosource/width}/\ctikzvalof{bipoles/ooosource/height})/
            ((2-sqrt(3))*2*\ctikzvalof{bipoles/ooosource/width}/\ctikzvalof{bipoles/ooosource/height}-1)
        }
        \edef\circleoffset{\pgfmathresult}%
    }
    \savedmacro{\vectorgroupoffset}{\edef\vectorgroupoffset{%
    \ctikzvalof{bipoles/oosourcetrans/vectorgroupoffset}}}
    % redefine right to enter the shape where the two right circle crosses
    % with respect to the natural center of the drawing (before the shifting)
    % is offset*cos(60) + sqrt(radius^2-(offset*sin(60))^2)
    \anchor{right}{
        \pgf@circ@ooo@anchor@base
        \pgfmathparse{ \circleoffset*0.5 +
            %%the sqrt must be > 0, the circles have to intersect
            %% the abs is to avoid crashes, but the result will be baaaad
            sqrt(abs(pow(\circlesize,2) - pow(\circleoffset*sqrt(3)/2,2)))
        }
        \pgf@x=\pgfmathresult\pgf@circ@res@other
        \advance\pgf@x by \pgf@circ@res@temp
        \pgf@y=0pt
    }
    % centers of the three circles
    \savedanchor{\centerprim}{% remove me
        \pgf@circ@ooo@anchor@base
        \pgf@x=-\circleoffset\pgf@circ@res@other
        \advance\pgf@x by \pgf@circ@res@temp
        \pgf@y=0pt
    }
    \anchor{centerprim}{\centerprim}
    \savedanchor{\centersec}{
        \pgf@circ@ooo@anchor@base
        \pgfpointpolar{60}{\circleoffset*\pgf@circ@res@other}
        \advance\pgf@x by \pgf@circ@res@temp
    }
    \anchor{centersec}{\centersec}
    \savedanchor{\centertert}{
        \pgf@circ@ooo@anchor@base
        \pgfpointpolar{-60}{\circleoffset\pgf@circ@res@other}
        \advance\pgf@x by \pgf@circ@res@temp
    }
    \anchor{centertert}{\centertert}
    % add some anchors in case the are needed :)
    \anchor{prim1}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centerprim}{\pgfpointpolar{135}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{prim2}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centerprim}{\pgfpointpolar{-135}{\circlesize\pgf@circ@res@other}}
    ...
    \anchor{sec1}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centersec}{\pgfpointpolar{0}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{sec2}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centersec}{\pgfpointpolar{45}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{sec3}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centersec}{\pgfpointpolar{90}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{tert1}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centertert}{\pgfpointpolar{0}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{tert2}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centertert}{\pgfpointpolar{-45}{\circlesize\pgf@circ@res@other}}
    }
    \anchor{tert3}{
        \pgf@circ@ooo@anchor@base
        \pgfpointadd{\centertert}{\pgfpointpolar{-90}{\circlesize\pgf@circ@res@other}}
    }
    % symbol "center" anchors
    \anchor{symbolprim}{
        \pgf@circ@ooo@anchor@base
        \pgf@x=-\vectorgroupoffset\pgf@circ@res@other
        \advance\pgf@x by \pgf@circ@res@temp
        \pgf@y=0pt
    }
    \anchor{symbolsec}{
        \pgf@circ@ooo@anchor@base
        \pgfpointpolar{60}{\vectorgroupoffset\pgf@circ@res@other}
        \advance\pgf@x by \pgf@circ@res@temp
    }
    \anchor{symboltert}{
        \pgf@circ@ooo@anchor@base
    ...
    \savedanchor{\textanchor}{%
        \pgf@circ@ooo@anchor@base
        \pgf@x=-.5\wd\pgfnodeparttextbox % (set)
        \pgf@y=.6\ht\pgfnodeparttextbox
        \advance\pgf@y by \pgf@circ@res@up
    }
...
{ooosource}
{\ctikzvalof{bipoles/ooosource/height}}
{\ctikzvalof{bipoles/ooosource/width}}% Notice that only very tied values of height and width will work
{
    %% find the drawing parameter @other:
    \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
    \pgf@circ@ooo@find@other
    \pgfmathsetlength{\pgf@circ@res@temp}{\circleoffset*\pgf@circ@res@other/4}
    %% move the origin 1/4 of the circle offset
    \pgftransformxshift{\pgf@circ@res@temp}
    % filling
    % left
    \pgfscope
        \pgfpathcircle{\pgfpoint{-\circleoffset\pgf@circ@res@other}{0}}{\circlesize\pgf@circ@res@other}
        \pgf@circ@maybefill
    \endpgfscope
    % up
    \pgfscope
        \pgfpathcircle{\pgfpointpolar{60}{\circleoffset\pgf@circ@res@other}}{\circlesize\pgf@circ@res@other}
        \pgf@circ@maybefill
    \endpgfscope
    % down also draw
    \pgfscope
...
% %     primary winding
    \ifpgf@circ@prim@delta
        \pgfscope
            \pgftransformxshift{-\vectorgroupoffset\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
...
% %     secondary winding
    \ifpgf@circ@sec@delta
        \pgfscope
            \pgftransformshift{\pgfpointpolar{60}{\vectorgroupoffset\pgf@circ@res@other}}
            \pgftransformrotate{\ctikzvalof{sources/symbol/sec rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/ooosource/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@sec@wye
...
% %     tertiary winding
    \ifpgf@circ@tert@delta
        \pgfscope
            \pgftransformshift{\pgfpointpolar{-60}{\vectorgroupoffset\pgf@circ@res@other}}
            \pgftransformrotate{\ctikzvalof{sources/symbol/tert rot}}
            \pgf@circ@delta{\ctikzvalof{bipoles/ooosource/vectorgroupscale}}
        \endpgfscope
...
\pgfcirc@activate@bipole@simple@opt{v}{oosourceatrans}{%
    \circuitikzbasekey/bipole/is voltage=true,
    \circuitikzbasekey/bipole/is voltageoutsideofsymbol=true}
...
\def\pgfcircdeclareIGCT#1#2#3{%name, fill (0-> black; 1-empty), gate position (1: catode, -1: anode)
    ...
    {\ctikzvalof{tripoles/thyristor/width}}
    {
        ...
        \pgfscope
            ...
            \pgfpathmoveto{\pgfpoint{\pgf@circ@res@step}{-\pgf@circ@res@down}}
            \pgfpathlineto{\pgfpoint{\pgf@circ@res@step}{\pgf@circ@res@down}}
            % compute the endpoint of the line starting from the bottom of the bar
            % and landing perpendicular to the lower part of the triangle
            \pgfmathsetmacro{\@@alpha}{atan(-\pgf@circ@res@down/(\pgf@circ@res@step-\pgf@circ@res@other))}
            \pgfmathsetmacro{\@@len}{-\pgf@circ@res@down*sin(\@@alpha)}
            \pgfpathlineto{\pgfpoint{\pgf@circ@res@step-\@@len*cos(\@@alpha)}{-\@@len*sin(\@@alpha)}}
            \pgfusepath{draw}
        \endpgfscope
        % back to normal linewidth
        % stroke if needed
    ...
    \pgfcircdeclarebipolescaled{switches}
        {
            ...
            \savedanchor{\textoffset}{%
                \pgf@x=-.5\wd\pgfnodeparttextbox % (set)
                \pgf@y=.6\ht\pgfnodeparttextbox  % (sum)
            }
            \anchor{text}{\pgfextractx{\pgf@xa}{\textoffset}\pgfextracty{\pgf@ya}{\textoffset}%
                \northeast \pgf@x=\pgf@xa \advance\pgf@y by \pgf@ya
            }
            \anchor{top arc}{\northeast
...
\def\pgf@circ@instruments@text@anchors{%
    % put the node text above and centered
    \savedanchor{\textoffset}{%
        \pgf@x=-.5\wd\pgfnodeparttextbox % (set)
        \pgf@y=\dimexpr .5\dp\pgfnodeparttextbox+.5\ht\pgfnodeparttextbox\relax % (sum)
    }
    \anchor{text}{\pgfextractx{\pgf@xa}{\textoffset}\pgfextracty{\pgf@ya}{\textoffset}
        \pgfextracty{\pgf@circ@res@up}{\northeast}
        \pgfpoint{\pgf@xa}{\pgf@circ@res@up+\pgf@ya}
    }
}
...
\pgfcircdeclarebipolescaled{instruments}
{
    ...
    \pgf@circ@instruments@text@anchors
}
...
\pgfcircdeclarebipolescaled{instruments}
{
    ...
    \anchor{text}{\pgfextractx{\pgf@xa}{\textoffset}\pgfextracty{\pgf@ya}{\textoffset}
        ...
        \pgfpoint{\pgf@xa+\pgf@circ@res@left}{\pgf@circ@res@up+\pgf@ya}
    }
}
...
\pgfdeclareshape{elmech}
{
    ...
    \savedanchor{\textanchor}{%
        \pgf@x=-.5\wd\pgfnodeparttextbox % (set)
        \pgf@y=-.5\ht\pgfnodeparttextbox  % (set)
    }
    \anchor{text}{\textanchor}
    \anchor{left}{%
        \northwest
...
{%
    ...
    \pgfpathcurveto
        {\pgfpoint{0.5\pgf@circ@res@left}{+0pt}}                   % CP1
        {\pgfpoint{0.4\pgf@circ@res@left}{0.6\pgf@circ@res@left}}  % CP2
        {\pgfpoint{+0pt}{+0pt}}                                    % FPA
    \pgfpathcurveto
        {\pgfpoint{.2\pgf@circ@res@right}{.2\pgf@circ@res@right}}  % CP3
        {\pgfpoint{.2\pgf@circ@res@right}{0.6\pgf@circ@res@right}} % CP4
        {\pgfpoint{+0pt}{0.6\pgf@circ@res@right}}                  % FPB
    \pgfpathcurveto
        {\pgfpoint{.2\pgf@circ@res@left}{0.6\pgf@circ@res@right}}  % symmetric to CP4
        {\pgfpoint{.2\pgf@circ@res@left}{.2\pgf@circ@res@right}}   % symmetric to CP3
        {\pgfpoint{+0pt}{+0pt}}                                    % same as FPA
    \pgfpathcurveto
        {\pgfpoint{0.4\pgf@circ@res@right}{0.6\pgf@circ@res@left}} % symmetric to CP2
        {\pgfpoint{0.5\pgf@circ@res@right}{+0pt}}                  % symmetric to CP1
        {\pgfpoint{0.8\pgf@circ@res@right}{\pgf@circ@res@zero}}    % symmetric to FPB
    \pgfusepath{draw}
}%
...
\pgfcirc@activate@bipole@simple{l}{wbulb}
